...
const PomodoroImages = () => {
  return (
    <>
      <div className="absolute md:w-[60%] left-[18%] top-0">
        <Image
      ...
      <div className="absolute w-[15em] -top-[3.5em] -left-[0%] md:w-[60%] md:left-[45%] md:top-[12%]">
        <Image
      ...
      <div className="absolute md:w-[20%] md:left-[30%] left-[10%] top-[90%]">
        <Image
      ...
      <div className="absolute left-[74%] w-[5em] -top-[1.5em] md:w-[20%] md:left-[70%] md:top-[90%]">
        <Image
